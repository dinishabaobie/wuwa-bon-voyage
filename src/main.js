...
const CHAPTERS = [
  ...
  },
  {
    ...
    keeper: '拉古那人习惯与声骸同行，把便利称为赐福，把规则称为神意。本终端无法判定，这究竟是安定，还是另一种形式的束缚——狂欢越是喧闹，水面之下的安静，就越值得有人去听。<br/><br/>外来植株生长稳定。<br/>与黑海岸环境匹配度不符。<br/>观测频率上调。',
  ...
  },
  {
    ...
    statusDesc: '七丘是黎那汐塔的城邦之一，把古罗马的圆拱、柱式与狮鹫，解构重组成一座现代之城。这里也是月光预见之地——人们依月相推演命运，将被预见的未来，奉为既定的轨迹。可实测读数正与预言悄然分岔：那条被月光照亮的轨道，开始偏移。',
