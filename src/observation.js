...
const PROFILES = {
  'S-002': {
    ...
    body: `
<section>
<h3 class="prof-h">一个很普通的愿望</h3>
<p>在千咲的记录里，我停留最久的地方，并不是她举起剪刀的瞬间。是后来，她说起自己还想去哪里：回到父母身边，去星炬学院看看同学。</p>
<p>那是一些普通得几乎不必特意记录的愿望。但在说出它们以前，她已经独自走了很远，也曾经尽力让自己不再需要任何人。我想知道，一个把联系逐一剪断的人，为什么还会想回家。</p>
<p>于是，我把记录向前翻。</p>
<p>六岁的夏天，家有清楚的模样。父亲的肩头、祭典的花火、手里的苹果糖，都是她可以靠近、可以相信的东西。千咲想把珍贵的事物框起来。一个孩子还不懂时间会改变什么，只知道喜欢的东西应该好好保存。</p>
<p>到十二岁，父母忙碌起来，一起吃饭的机会渐渐少了。留在家中的便签能交代事情，却不能陪她坐一会儿。她尝试做一份适合全家围坐的料理，把牛肉和野菜放进锅里。饭可以由她准备，桌前的空位却需要别人回来填上。</p>
<p>我无法替那时的她说出所有心事。但我愿意把这顿饭放在档案开头：在学会剪断以前，千咲一直在试着把人留在身边。</p>
</section>
<section>
<h3 class="prof-h">伸手的人，成了被推开的人</h3>
<p>十五岁，她撞见绿子被欺凌，出手阻止。她的行动有一个很直接的理由：眼前的人正在受伤，不能就这样看下去。</p>
<p>共鸣力在这次冲突中觉醒。随之而来的并非赞许。在她生活的苇原，共鸣者受到敌视与管制；她也从帮助别人的人，变成了新的欺凌对象。与此同时，她失去了辨认人脸的能力。恶意有了声音、有了纸条，却没有一张她能够确定的面孔。</p>
<p>这样的日子很难靠一次勇敢结束。明天仍要走进教室，仍要面对无法辨认的人。她渐渐减少交流，把伤人的纸条剪碎。沉默至少能让自己少暴露一些，距离至少能挡住一部分接触。</p>
<p>到了十六岁，检测与抑制器进一步挤占了日常。她也顾虑着家人和其他共鸣者：如果自己反抗，后果会不会落到他们身上？别人的敌意，竟成了她约束自己的理由。</p>
<p>我不愿把这种忍耐写成一种应当赞美的品格。她不该因为能够忍受，就被要求继续忍受；也不该因为拥有力量，就被认为理应独自解决一切。她当时能看见的选择，实在太少。</p>
<div class="prof-note">观测者手记 / 这一段对沉默与自责的理解，属于我的解读。遭受排斥的责任不在千咲身上，她也不需要用更多温柔来证明自己值得被善待。</div>
<p>不过，记录没有在恶意那里封口。一个被她帮助过的孩子，曾送来棉花糖；母亲也没有放弃她。她夜里在壁橱发现过一只野猫，后来猫不见了，这件事便留成了一个谜。世界并没有因此变好，但她的生活里，仍然存在值得好奇、值得接住的东西。</p>
</section>
<section>
<h3 class="prof-h">有些改变，从换一个地方开始</h3>
<p>千咲离开苇原，转入星炬学院。这里给她最初的礼物，是不必时刻提防别人的反应。她的能力不再自动招来恐惧，机械研究可以占据注意力，明天也可以围绕新的兴趣展开。</p>
<p>这段经历使我留意到环境的分量。同一个人，在一个地方被迫不断防备，在另一个地方，却能够开始学习、尝试和期待。不能把她全部的退缩都归结为性格，也不能要求她先整理好过去，才有资格离开伤害。</p>
<p>她还没有与所有往事和解，但日子已经可以先过下去。与旧生活拉开距离，让她有机会发现自己除了受伤和忍耐，还能做什么。</p>
<p>后来，一只小黑猫将要坠入索诺拉，她伸手去救，也被卷了进去。我不把这一刻理解为她已经痊愈的证明。只是，那个曾经为绿子站出来的千咲，并没有完全消失。看见生命处于危险中，她仍会有所行动。</p>
<p>这次，她抵达了旧穗波市。一座同样无法摆脱过去的城。</p>
</section>
<section>
<h3 class="prof-h">被留下的时间，也需要一个出口</h3>
<p>旧穗波早已被悲鸣吞没。索诺拉保存着灾难中的人和他们未完成的心愿。往人在岁破中经历死亡与归来，重逢并没有带来真正的明天。</p>
<p>千咲称它为琥珀。被保存的东西看似没有失去，却也无法继续变化。童年想要框住幸福的愿望，在这里有了令人难过的回声：如果连痛苦也一并凝固，永久留下并不等于得到幸福。</p>
<p>沉夏曾在这里陪伴她。对长久独自承受的千咲而言，有人认真听她说话、与她一起面对困境，本身就是一种新的经验。联系不总是带来负担，也可以让一个人撑过原本难以撑过的日子。</p>
<p>但沉夏能留下的时间有限。他的身体接近极限，最终走进虹音塔，为她带来了漂泊者。他希望她活着离开。这个愿望越过了他无法继续同行的地方，交到了后来者手里。</p>
<p>漂泊者与千咲一起走过余下的路。信任没有凭空出现，它来自倾听、共同面对危险，以及一次次没有离开的行动。她终于不必把所有判断与后果都独自担住。</p>
<p>他们也必须接受，灾难不能被简单抹去。要面对的，是如何让困在那一天的人走到各自的结局。时间重新流动之后，樱花、礼物、汽水与蛋糕仍可以承载记忆，不必再让痛苦不断重演，来证明过去曾经发生。</p>
<div class="prof-note">观测者手记 / 我把旧穗波看作理解千咲的一面镜子：城需要走出停住的那一天，她也需要让旧日经历不再决定此后的每一步。这是阅读上的联系，并非对索诺拉设定的补充。</div>
<p>保存与放下，原来可以同时发生。有些人无法继续陪伴，曾经相伴的日子却仍然存在。故事走到这里，才重新回到档案开头的那个愿望。</p>
</section>
<section>
<h3 class="prof-h">回去，也可以是一种向前</h3>
<p>她想回家，也想回学院。此时的回去，已经有了新的意味。她曾为了保护自己离开，如今开始考虑，哪些人仍然值得见面，哪些关系愿意再试着靠近。</p>
<p>她还想亲手取下抑制器。我更愿意停在“亲手”这两个字上。这个动作尚待她完成，时机也应该由她决定。经历过那么多被规定、被评判的日子，能够为自己的生活作出选择，本身就有分量。</p>
<p>我不会在此替她宣布一切已经好起来了。愿望与实现之间还有距离，愿意相信与不再害怕之间，也可能隔着许多次迟疑。记录应当给这些迟疑留出空间。</p>
<p>红线依然会连接她与别人。她可以保留让自己安心的联系，也可以拒绝持续伤害她的关系；有些暂时分不清的，不必立刻作答。剪刀在她手里，她不需要再一次剪断全部，也不必为了证明成长而接回全部。</p>
<p>如果下一次记录里，她只是和家人吃了一顿饭，去见了同学，或专心摆弄了一件有意思的机械，我也会认真收下。那些没有巨大转折的日子，正是她曾经想重新拥有的生活。</p>
</section>
<div class="prof-sign">
<p>最初看见她时，人很容易记住剪刀。我希望读到这里，还能记住那口等人回家吃饭的锅。</p>
<p>它提醒我，千咲并非生来就想与世界保持距离。她曾期待陪伴，在受伤后退开，又在新的相遇里试着向前。要理解她，需要把这些时刻放在一起，而不是只替她挑出最漂亮或最悲伤的一幕。</p>
<p>记录暂存。她接下来会去哪里，愿意把线牵向谁，都还有待她自己选择。这里空着的下一页，属于她。</p>
</div>
`,
  },
